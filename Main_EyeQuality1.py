...
import os
os.chdir("C:\\Users\\hso\\Documents\\EyeQ-master\\MCF_Net")
...
data_root = 'C:/Users/hso/Documents/RetinalCLSAData'
...
test_images_dir = data_root + '/2301020_forImages_BL_crop'
label_test_file = '../data/2301020_forImages_BLTest.csv'

save_file_name = args.model_dir + args.save_model + '2301020_forImages_BLResult.csv'
...
#Python's multiprocessing module requires that the main module be importable by the child processes.     
